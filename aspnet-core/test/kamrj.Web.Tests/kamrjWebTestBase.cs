...
{
    public abstract class kamrjWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static kamrjWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(kamrjWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<kamrjDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<kamrjDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<kamrjDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<kamrjDbContext, Task<T>> func)
        {
            T result;
