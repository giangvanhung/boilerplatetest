...
namespace kamrj.Migrations
{
    ...
    [Migration("20260703041623_Them_Layer_Feature_Style")]
    partial class Them_Layer_Feature_Style
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kamrj.Core.Models.Feature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("kamrj.Core.Models.Layer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("kamrj.Core.Models.Style", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("kamrj.Security.Entities.SecurityPolicySetting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("kamrj.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("kamrj.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("kamrj.Core.Models.Feature", b =>
                {
                    b.HasOne("kamrj.Core.Models.Layer", "Layer")
                        .WithMany("features")
