...
namespace kamrj.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly kamrjDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = kamrjConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(kamrjDbContext context)
        {
            _context = context;
        }
