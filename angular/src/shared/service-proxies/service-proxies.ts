...
export class FeatureServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<FeatureDto> {
     ...
     * @return Success
     */
    create(body: FeatureDto | undefined): Observable<FeatureDto> {
     ...
     * @return Success
     */
    update(body: FeatureDto | undefined): Observable<FeatureDto> {
...
@Injectable()
export class LayerServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<LayerDto> {
        let url_ = this.baseUrl + "/api/services/app/Layer/Get?";
        if (id === null)
            throw new globalThis.Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<LayerDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LayerDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<LayerDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = LayerDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<LayerDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<LayerDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Layer/GetAll?";
        if (sorting === null)
            throw new globalThis.Error("The parameter 'sorting' cannot be null.");
        else if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<LayerDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LayerDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<LayerDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = LayerDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<LayerDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    create(body: LayerDto | undefined): Observable<LayerDto> {
        let url_ = this.baseUrl + "/api/services/app/Layer/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<LayerDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: LayerDto | undefined): Observable<LayerDto> {
        let url_ = this.baseUrl + "/api/services/app/Layer/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<LayerDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Layer/Delete?";
        if (id === null)
            throw new globalThis.Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
@Injectable()
export class SecurityPolicyServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(): Observable<PasswordPolicyDto> {
        let url_ = this.baseUrl + "/api/services/app/SecurityPolicy/Get";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PasswordPolicyDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PasswordPolicyDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<PasswordPolicyDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PasswordPolicyDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PasswordPolicyDto>(null as any);
    }
     ...
     * @return Success
     */
    update(body: PasswordPolicyDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SecurityPolicy/Update";
        url_ = url_.replace(/[?&]$/, "");
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["styles"])) {
                ...
                for (let item of _data["styles"])
                    this.styles!.push(StyleDto.fromJS(item));
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.styles)) {
            ...
            for (let item of this.styles)
                data["styles"].push(item ? item.toJSON() : undefined as any);
        }
...
export class LayerDtoPagedResultDto implements ILayerDtoPagedResultDto {
    items!: LayerDto[] | undefined;
    totalCount!: number;

    constructor(data?: ILayerDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(LayerDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): LayerDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new LayerDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface ILayerDtoPagedResultDto {
    items: LayerDto[] | undefined;
    totalCount: number;
}

export class PasswordPolicyDto implements IPasswordPolicyDto {
    ...
    constructor(data?: IPasswordPolicyDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.forceChangePasswordFirstLogin = _data["forceChangePasswordFirstLogin"];
            ...
            this.passwordExpirationDays = _data["passwordExpirationDays"];
            this.maxFailedAccessAttempts = _data["maxFailedAccessAttempts"];
            this.lockoutMinutes = _data["lockoutMinutes"];
        }
    }

    static fromJS(data: any): PasswordPolicyDto {
        data = typeof data === 'object' ? data : {};
        let result = new PasswordPolicyDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["forceChangePasswordFirstLogin"] = this.forceChangePasswordFirstLogin;
        data["requiredLength"] = this.requiredLength;
        data["requireUppercase"] = this.requireUppercase;
        data["requireLowercase"] = this.requireLowercase;
        data["requireDigit"] = this.requireDigit;
        data["requireNonAlphanumeric"] = this.requireNonAlphanumeric;
        data["passwordExpirationDays"] = this.passwordExpirationDays;
        data["maxFailedAccessAttempts"] = this.maxFailedAccessAttempts;
        data["lockoutMinutes"] = this.lockoutMinutes;
        return data;
    }

    clone(): PasswordPolicyDto {
        const json = this.toJSON();
        let result = new PasswordPolicyDto();
        result.init(json);
        return result;
...
export interface IPasswordPolicyDto {
    forceChangePasswordFirstLogin: boolean;
    requiredLength: number;
    requireUppercase: boolean;
    requireLowercase: boolean;
...
export class StyleDto implements IStyleDto {
    id!: number;
    name!: string | undefined;
    styleJson!: string | undefined;

    constructor(data?: IStyleDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.name = _data["name"];
            this.styleJson = _data["styleJson"];
        }
    }

    static fromJS(data: any): StyleDto {
        data = typeof data === 'object' ? data : {};
        let result = new StyleDto();
        result.init(data);
        return result;
    }
